                ...
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" name="submit" type="submit">PROCEED FOR RECOVERY <i
                        ...
                        <div class="login-form-body">
                            <form method="POST" name="updatepwd">
                                <div class="form-gp">
                                    ...
                                    <input type="password" id="exampleInputEmail1" name="newpassword" required
                                        autocomplete="off">
                                    <i class="ti-key"></i>
                                    <div class="text-danger"></div>
                                </div>
                                <div class="form-gp">
                                    ...
                                    <input type="password" id="exampleInputPassword1" name="confirmpassword" required
                                        autocomplete="off">
                                    <i class="ti-key"></i>
                                    <div class="text-danger"></div>
                                </div>
                                ...
                                <div class="submit-btn-area">
                                    <button id="form_submit" name="change" type="submit">DONE <i
                                            class="ti-arrow-right"></i></button>
                                </div>
                            </form>
                        <?php } else { ?>
