...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    <head>
        ...
        <title>Employee Leave Request System</title>
                    ...
                    <div class="menu-inner">
                        <nav>
                            <ul class="metismenu" id="menu">
                                ...
                                <li class="#">
                                    <a href="leave-history.php" aria-expanded="true"><i class="ti-agenda"></i><span>View My
                                            Leave History
                                        </span></a>
                                </li>
                                    ...
                                    <div class="card">
                                        <form name="chngpwd" method="POST">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="text-muted font-14 mb-4">Please fill up the form to change your
                                                    current password.</p>

                                                <div class="form-group">
                                                    <label for="example-date-input" class="col-form-label">Existing
                                                        Password</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="example-date-input" class="col-form-label">New
                                                        Password</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="example-date-input" class="col-form-label">Confirm
                                                        Password</label>
                                                ...
                                                <button class="btn btn-primary" name="change" type="submit"
                                                    onclick="return valid();">CHANGE PASSWORD</button>
